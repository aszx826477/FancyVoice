...
public class name_act extends Activity {
    ...
    public static name_act instance;
    ...
    */
    ...
    public void matching(String str, View v) {
        if (v instanceof ViewGroup) {
            ...
            if(str.equals("波比")&&(v.getId()== R.id.ming)) {
        ...
        public void handleMessage(Message msg) {
            switch(msg.what) {
                case 4:
                    ...
                    Intent intent=new Intent(name_act.this, celebration_act.class); startActivity(intent);
