 ...
 */
 package top.yelbee.www.myapplication.View;
...
import top.yelbee.www.myapplication.Controller.Utils;
...
public class ExplosionAnimator extends ValueAnimator {
    ...
    public boolean draw(Canvas canvas) {
        ...
        for (Particle particle : mParticles) {
        	//float a1=Float.parseFloat((String) getAnimatedValue());    //knot to fix !!!
