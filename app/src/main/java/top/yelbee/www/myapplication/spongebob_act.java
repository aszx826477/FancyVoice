...
public class spongebob_act extends Activity {
    ...
    public static spongebob_act instance;
    ...
    */
    ...
    public void matching(String str, View v) {
        if (v instanceof ViewGroup) {
            ...
            if(str.equals("海绵宝宝")&&(v.getId()== R.id.spongebob)) {
    ...
    final Handler handler=new Handler() {
        public void handleMessage(Message msg) {
            switch(msg.what) {
                case 2:
                    Intent intent=new Intent(spongebob_act.this, sherlock_act.class); startActivity(intent);
                    break;
                default:
