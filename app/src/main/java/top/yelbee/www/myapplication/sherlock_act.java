...
public class sherlock_act extends Activity {
    ...
    public static sherlock_act instance;
    ...
    */
    ...
    public void matching(String str, View v) {
        if (v instanceof ViewGroup) {
            ...
            if(str.equals("福尔摩斯")&&(v.getId()== R.id.sherlock)) {
    ...
    final Handler handler=new Handler() {
        public void handleMessage(Message msg) {
            switch(msg.what) {
                case 3:
                    Intent intent=new Intent(sherlock_act.this, name_act.class); startActivity(intent);
                    break;
                default:
